...
/*		Image catImg = getImage(ClassLoader.getSystemResource("cat.gif"));
	...
	public void updateBoard() {
		...
		Dimension[] cases={new Dimension(BX-3,(int)(BY/2)),new Dimension(BX-1,(int)(BY/2)),new Dimension(BX-2,-1+(int)(BY/2)),new Dimension(BX-2,1+(int)(BY/2))};
		for(int i=0;i<4;i++){
			if(i==game.getScoringArea()) bp.setSquare(cheese, cases[i]);
			else bp.setSquare(cat, cases[i]);
		}
