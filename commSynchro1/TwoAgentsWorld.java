...
public class TwoAgentsWorld implements RLWorld {
	...
	public int fail = 0;
	public int succesReward1 = 100;
	public int failPunishment= 45;
	public int constantPenalty=40;

	static final int NUM_OBJECTS1 = 5, NUM_OBJECTS2 = 4, NUM_ACTIONS1 = 2,NUM_ACTIONS2=5, WALL_TRIALS = 100;
	...
	public double calcReward1() {
		...
		else newReward-=constantPenalty;
		System.out.println(newReward);
		return newReward;
	}
